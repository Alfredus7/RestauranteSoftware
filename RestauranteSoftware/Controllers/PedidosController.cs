...
namespace RestauranteSoftware.Controllers
{
    public class PedidosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Pedidos.Include(p => p.EstadoPedido).Include(p => p.TipoPedido);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoPedidoId"] = new SelectList(_context.TiposPedidos, "Id", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoPedidoId,EstadoId")] PedidosEntitys pedidosEntitys)
        {
            ...
            ViewData["TipoPedidoId"] = new SelectList(_context.TiposPedidos, "Id", "Nombre", pedidosEntitys.TipoPedidoId);
            return View(pedidosEntitys);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoPedidoId,EstadoId")] PedidosEntitys pedidosEntitys)
        {
