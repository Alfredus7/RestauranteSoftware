...
namespace RestauranteSoftware.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NroMesa,Fecha,EstadoId,IsPrioridad,TotalPedido")] PedidosEntitys pedidosEntitys)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NroMesa,Fecha,EstadoId,IsPrioridad,TotalPedido")] PedidosEntitys pedidosEntitys)
        {
